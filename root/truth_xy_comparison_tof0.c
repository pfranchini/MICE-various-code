...

{
  ...
  is.open("7469/7-tof0.txt");  //
  //is.open("260/batch/output_0/7-tof0.txt");  //   
  ...
  //T->Draw("data._spill._recon->_tof_event->_tof_space_points._tof0._global_x:data._spill._recon->_tof_event->_tof_space_points._tof0._global_y >> xy_data");
  //xy_data->Draw("colz");
  //c1->SaveAs("7469_xy_data.png");

  T->Draw("data._spill._recon->_tof_event->_tof_space_points._tof0._global_x >> x_data");
  T->Draw("data._spill._recon->_tof_event->_tof_space_points._tof0._global_y >> y_data");
  ...
  x_MC->Draw();
  x_data->Draw("same");
  c1->SaveAs("7469_truth_x_tof0.png");
  ...
  y_MC->Draw();
  y_data->Draw("same");
  c1->SaveAs("7469_truth_y_tof0.png");
...
*/
  ...
  c1->SaveAs("deltat_7469_hi-stat.png");
