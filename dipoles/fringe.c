...

{
  ...
  while (is.good())
    {
      ...
      data_Z[i] = (717.45 - 6.7-(750-z) -26.21 + 1000);      //rescale
      data_B[i] = By/1000;
  ...
  TF1 *enge = new TF1("enge","0.42/( 1+exp( [0] + [1]*(((x-[6])/153.5)) + [2]*(((x-[6])/153.5))^2 + [3]*(((x-[6])/153.5))^3  + [4]*(((x-[6])/153.5))^4 + [5]*(((x-[6])/153.5))^5 ))  ",1000,2000);
  enge->SetParameter(6, 1000);      

  graph2->Fit("enge","R");
  cout << endl << enge->GetParameter(0) << "," << enge->GetParameter(1) << ","<< enge->GetParameter(2) << ","<< enge->GetParameter(3) << ","<< enge->GetParameter(4) << ","<< enge->GetParameter(5) << endl;

  cout << endl << "Fit MC..." << endl;
  TF1 *enge2 = new TF1("enge2","0.42/( 1+exp([0] + [1]*(((x-[6])/153.5)) + [2]*(((x-[6])/153.5))^2 + [3]*(((x-[6])/153.5))^3  + [4]*(((x-[6])/153.5))^4 + [5]*(((x-[6])/153.5))^5 )) ",1000,2000);
